...
const HASH_DOMAIN = "PADI_SOVEREIGN_V1.9.6";
...
export function canonicalize(obj) {
    ...
    if (type !== '[object Object]' && type !== '[object Array]' && typeof obj === 'object') {
        throw new Error("CANON_ERR: Non-plain objects prohibited");
    }
...
export function signablePayload(payload) {
